...
#$ -cwd
#$ -N e4-step2
#$ -o ./qsub_logs/e4-step2.$JOB_ID.$TASK_ID.o
#$ -e ./qsub_logs/e4-step2.$JOB_ID.$TASK_ID.e
#$ -l h_rt=47:00:00
#$ -l h_vmem=5G
#$ -pe sharedmem 4
#$ -t 1-22
...
mkdir -p ${E4ADJ_DIR}/output/

## apoe e4 count adjusted
regenie \
  --step 2 \
  ...
  --pred ${E4ADJ_DIR}/step1/ukb_e4Adj_pred.list \
  --bsize 400 \
  --out ${E4ADJ_DIR}/output/ukb_e4Adj_c${CHR} \
  --threads $(nproc)
